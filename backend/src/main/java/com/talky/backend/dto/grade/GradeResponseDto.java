...
public class GradeResponseDto {
    ...
    public static GradeResponseDto fromUserExamResult(UserExamResult result) {
        GradeResponseDto.GradeResponseDtoBuilder builder = GradeResponseDto.builder()
                ...
                .reviewed(result.getReviewed() != null ? result.getReviewed() : false)
    ...
    /**
     * Convierte una entidad UserExamResult a GradeResponseDto para estudiantes.
     * Incluye las respuestas del estudiante siempre, pero el frontend solo mostrará
     * las respuestas correctas si el examen ha sido revisado por el profesor.
     */
    public static GradeResponseDto fromUserExamResultForStudent(UserExamResult result) {
        // Devolver todas las respuestas del estudiante (el frontend manejará la visibilidad)
        return fromUserExamResult(result);
    }
}
