...
public class UserController {
    ...
    public ResponseEntity<com.talky.backend.dto.UserResponseDto> assignCourseToStudent(@PathVariable UUID userId, @PathVariable UUID courseId) {
        User user = userService.assignCourseToStudent(userId, courseId);
        return ResponseEntity.ok(com.talky.backend.dto.UserResponseDto.fromUser(user));
    }
    ...
    @PreAuthorize("hasAnyRole('ADMIN','TEACHER')")
    public ResponseEntity<com.talky.backend.dto.UserResponseDto> removeCourseFromStudent(@PathVariable UUID userId) {
